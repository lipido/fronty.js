describe('Fronty.TreeComparator', () => {
  ...
  it('it should do complex patches when keys/non-keys are used', () => {
    ...
    expect(diff).toEqual(
      [{
          mode: Fronty.TreeComparator.PATCH_REPLACE_NODE,
        ...
        },
        {
          mode: Fronty.TreeComparator.PATCH_APPEND_CHILD,
          toReplace: node1,
          replacement: node2.childNodes[3] //<p>Pxbix</p>
        }
  ...
  it('it should do complex optimized patches when keys are used', () => {
    ...
    expect(diff).toEqual(
      [{
          mode: Fronty.TreeComparator.PATCH_REPLACE_NODE,
          toReplace: node1.childNodes[0], // <p key="1">
          replacement: node2.childNodes[0] // <p key="n">Pn</p>
        },
        {
